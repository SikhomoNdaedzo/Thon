...
def emaillogin():
    ...
    Label(f, text="IRELIA", font=("Helvetica", 30, "bold"), bg='#FFF', fg="#2F9DFF").place(x=180, y=120)
    Label(f, text='sign in to continue', font=("Helvetica", 12, "bold"), fg='#666A6C', bg='#FFF').place(x=170, y=170)
